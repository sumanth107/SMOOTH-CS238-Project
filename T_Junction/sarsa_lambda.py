...
class SARSA_Lambda:
    def __init__(self, env, alpha=0.5, gamma=0.95, epsilon=0.0, epsilon_decay=0.99, min_epsilon=0.01, lamb=0.9):
        self.env = env
        self.alpha = alpha
        self.gamma = gamma
    ...
    def learn(self, state, action, reward, next_state, next_action, done):
        ...
        delta = reward + self.gamma * self.Q[next_position, next_velocity, next_action] - self.Q[
    ...
    def train(self, num_episodes):
        ...
        plot_test_performance(rewards, 'sarsa_lambda_results.png')
...
if __name__ == "__main__":
    ...
    for _ in range(RANDOM_RUNS):
        ...
        for step in range(n_steps):
            ...
            action = model.choose_action(discrete_state)
